...
<template>
  <div class="sc-icon-select">
    <el-input v-model="defaultValue" :placeholder="placeholder" :clearable="clearable" :disabled="disabled">
      <template #append>
    ...
    <el-dialog v-model="dialogVisible" title="图标选择器" :width="780" destroy-on-close>
