<template>
  <div ref="" v-drag class="mobile-nav-button" draggable="false" @click="showMobileNav($event)"><el-icon><menu /></el-icon></div>

  <el-drawer ref="mobileNavBox" v-model="nav" title="移动端菜单" :size="240" direction="ltr" :with-header="false" destroy-on-close>
    <el-container class="mobile-nav">
      ...
      <el-main>
        <el-scrollbar>
          <el-menu :default-active="$route.meta.active || $route.fullPath" router background-color="#212d3d" text-color="#fff" active-text-color="#409EFF" @select="select">
