        ...
        <el-tab-pane label="系统设置">
          <el-form ref="form" :model="sys" label-width="100px" style="margin-top: 20px;">
            ...
            <el-form-item label="版权信息">
              <el-input v-model="sys.copyright" type="textarea" :autosize="{minRows: 4}" />
            </el-form-item>
            <el-form-item>
        ...
        <el-tab-pane label="扩展配置">
          ...
          <el-table :data="setting" stripe>
            ...
            <el-table-column label="操作" fixed="right" width="100">
              <template #default="scope">
                <el-button type="text" size="small" @click="table_edit(scope.row, scope.$index)">{{ scope.row.isSet?'保存':"修改" }}</el-button>
                <el-button v-if="scope.row.isSet" type="text" size="small" @click="scope.row.isSet=false">取消</el-button>
          ...
          <el-button type="primary" style="margin-top: 20px;" @click="table_add">
            <icon-ep-plus />
          </el-button>
        </el-tab-pane>
      </el-tabs>
