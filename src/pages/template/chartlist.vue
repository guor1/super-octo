  ...
  <el-container>
    <el-header>
      <div class="left-panel">
        ...
        <el-date-picker v-model="date" type="datetimerange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期" size="mini" />
      </div>
    </el-header>
    <el-main>
      <el-card shadow="never">
        ...
        <div class="chart">
          <el-row>
            <el-col :span="8">
              <scEcharts height="250px" :option="pie" />
            </el-col>
            <el-col :span="16">
              <scEcharts height="250px" :option="option" />
            </el-col>
          </el-row>
        </div>
      </el-card>
      <el-card shadow="never">
        <scTable ref="table" :data="data" show-summary height="auto">
          <el-table-column label="来源类型" prop="type" />
          <el-table-column label="网站基础指标" align="center">
            <el-table-column label="访客数(UV)" prop="uv" width="150" />
            <el-table-column label="IP数" prop="ip" width="150" />
          </el-table-column>
          <el-table-column label="流量质量指标" align="center">
            <el-table-column label="跳出率" prop="out" width="150" />
            <el-table-column label="平均访问时长" prop="time" width="150" />
          </el-table-column>
        </scTable>
      </el-card>
    </el-main>
