    ...
    <el-card shadow="never" header="分步表单">
      ...
      <el-row>
        <el-col :lg="{span: 8, offset: 8}">
          <el-form v-if="active==0" ref="stepForm_0" :model="form" :rules="rules" label-position="top">
            <el-form-item label="付款账户" prop="paymentAccount">
              <el-select v-model="form.paymentAccount" clearable>
                <el-option label="sakuya@scui.com" value="sakuya@scui.com" />
                <el-option label="lolicode@scui.com" value="lolicode@scui.com" />
              </el-select>
            </el-form-item>
            <el-form-item label="收款账户" prop="collectionAccount">
              <el-input v-model="form.collectionAccount" clearable />
            </el-form-item>
          ...
          <el-button v-if="active==1" type="primary" :loading="submitLoading" @click="submit">提交</el-button>
        </el-col>
      </el-row>
    </el-card>
  </el-main>
