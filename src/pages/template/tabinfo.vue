  ...
  <el-container>
        ...
        <el-row :gutter="15">
          ...
          <el-col :lg="16">
            <el-card shadow="never">
              <el-row :gutter="15">
                <el-col :lg="8">
                  <sc-statistic title="订单量" value="6400" suffix="Kg" group-separator />
                </el-col>
                <el-col :lg="8">
                  <sc-statistic title="发货量" value="1568.873" suffix="Kg" group-separator />
                </el-col>
                <el-col :lg="8">
                  <sc-statistic title="订单金额" value="1920000" prefix="¥" group-separator />
                </el-col>
              </el-row>
            </el-card>
          </el-col>
        ...
        <el-card shadow="never" style="margin-top: 15px;">
          <el-tabs>
            ...
            <el-tab-pane label="物流记录" lazy>
              <scTable ref="table" :data="list" stripe hide-do>
    ...
    <el-aside width="300px" style="border-left: 1px solid #e6e6e6;border-right: 0;padding:15px;">
      ...
      <div class="side-item">
        ...
        <div class="content">
          <scEcharts height="200px" :option="radarsOption" />
        </div>
      </div>
    </el-aside>
  </el-container>
