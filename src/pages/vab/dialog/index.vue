...
<template>
  <el-main>
    <el-alert title="二次封装el-dialog,加入拖拽/加载中/最大化." type="success" style="margin:0 0 20px 0;" />
    ...
    <el-card shadow="never" header="异步" style="margin-top: 15px;">
      ...
      <el-alert title="适用于页面有很多弹窗操作,利用异步组件按需加载,加快首屏的加载速度和打包体积" style="margin-top: 20px;" />
    </el-card>
  </el-main>
  ...
  <sc-dialog v-model="dialog2" title="模拟加载" :width="400" :loading="dialog2Loading">
    <el-empty description="NO Data" :image-size="80" />
    <template #footer>
      <el-button @click="dialog2 = false">取 消</el-button>
      <el-button type="primary" :loading="dialog2Loading" @click="dialog2 = false">确 定</el-button>
    </template>
  </sc-dialog>
  ...
  <dialog1 v-if="asynDialog1" @closed="asynDialog1 = false" />
  <dialog2 v-if="asynDialog2" @closed="asynDialog2 = false" />
</template>
