<template>
  <el-main>
    <el-card shadow="never" header="v-auth 高精度权限控制">
      ...
      <el-alert title="v-auth指令 是$AUTH的语法糖, 原先需要使用v-if来判断是否有权限, 使用指令将减少代码冗余. 并且支持传入数组,有一项满足就判断有权限" style="margin-top: 20px;" />
    </el-card>
    ...
    <el-card shadow="never" header="v-copy 一键复制" style="margin-top: 15px;">
      <el-input v-model="copyText" type="textarea" :rows="2" placeholder="请输入内容" />
