      ...
      <el-col :lg="8">
        <el-card shadow="never" header="脉冲圆点">
          <el-space wrap :size="15">
            <sc-status-indicator pulse type="primary" />
            <sc-status-indicator pulse type="success" />
            <sc-status-indicator pulse type="warning" />
            <sc-status-indicator pulse type="danger" />
            <sc-status-indicator type="info" />
          </el-space>
        </el-card>
      </el-col>
      <el-col :lg="8">
        <el-card shadow="never" header="趋势">
          <el-space wrap :size="15">
            <sc-trend v-model="trendValue" prefix="¥" />
            <sc-trend v-model="trendValue2" />
            <sc-trend v-model="trendValue3" suffix="%" />
          </el-space>
