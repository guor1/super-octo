    ...
    <el-row :gutter="15">
      <el-col :lg="12">
        <el-card shadow="never" header="异步单选">
          <sc-select v-model="value" :api-obj="$API.system.dic.get" clearable filterable />
        </el-card>
      </el-col>
      <el-col :lg="12">
        <el-card shadow="never" header="异步多选">
          <sc-select v-model="value2" :api-obj="$API.system.dic.get" clearable filterable multiple />
        </el-card>
      </el-col>
      <el-col :lg="12">
        <el-card shadow="never" header="字典选择器">
          <sc-select v-model="value3" dic="notice" clearable filterable />
        </el-card>
      </el-col>
      <el-col :lg="12">
