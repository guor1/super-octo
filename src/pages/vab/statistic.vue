    ...
    <el-row :gutter="15">
      <el-col :lg="8">
        <el-card shadow="never">
          <sc-statistic title="Title" value="112893" description="Description" tips="Tips" group-separator />
        </el-card>
      </el-col>
      <el-col :lg="8">
        <el-card shadow="never">
          <sc-statistic title="今日净利润" value="112893.00" prefix="¥" group-separator>
            <sc-trend v-model="trendValue1" />
          </sc-statistic>
        </el-card>
      </el-col>
      <el-col :lg="8">
        <el-card shadow="never">
          <sc-statistic title="留言" value="112893" suffix="条" group-separator>
