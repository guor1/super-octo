...
<template>
  <el-main>
    ...
    <el-card shadow="never" header="单选">
      <sc-table-select v-model="value2" :api-obj="apiObj" :params="params" :table-width="600" :props="props">
    ...
    <el-card shadow="never" header="多选">
      <sc-table-select v-model="value" :api-obj="apiObj" :table-width="700" multiple :props="props">
        <template #header="{form, submit}">
          <el-form :inline="true" :model="form">
            ...
            <el-form-item>
              <el-date-picker v-model="form.date" value-format="YYYY-MM-DD" type="date" placeholder="注册时间" :append-to-body="false" />
            </el-form-item>
            <el-form-item>
