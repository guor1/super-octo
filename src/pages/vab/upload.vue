<template>
  <el-main>
    <el-card shadow="never" header="基础示例">
      ...
      <sc-upload v-model="imgurl4" title="开启剪裁" :cropper="true" :compress="1" :aspect-ratio="1/1" />
    </el-card>
        ...
        <el-form-item label="身份证" class="imglist" required>
          <el-col>
            <el-form-item prop="img1">
              <sc-upload v-model="form.img1" title="人像面" />
            </el-form-item>
          </el-col>
          <el-col>
            <el-form-item prop="img2">
              <sc-upload v-model="form.img2" title="国徽面" />
            </el-form-item>
          </el-col>
        </el-form-item>
        <el-form-item label="其他凭证" prop="img3">
          <sc-upload-multiple v-model="form.img3" />
        </el-form-item>
